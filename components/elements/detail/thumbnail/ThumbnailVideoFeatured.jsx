                    ...
                    <div className="ps-wrapper">
                        <Slider
                            ...
                            <div className="item">
                                ...
                                <Link href="/static/img/products/detail/fullwidth/1.jpg">
                                    <a>
                                        <img src="/static/img/products/detail/fullwidth/1.jpg" alt="martfury" width="200" height="200" />
                                    </a>
                                </Link>
  
                            </div>
                            <div className="item">
                                <Link href="/static/img/products/detail/fullwidth/2.jpg">
                                    <a>
                                        <img src="/static/img/products/detail/fullwidth/2.jpg" alt="martfury" width="200" height="200" />
                                    </a>
                                </Link>
                            </div>
                            <div className="item">
                                <Link href="/static/img/products/detail/fullwidth/23.jpg">
                                    <a>
                                        <img src="/static/img/products/detail/fullwidth/3.jpg" alt="martfury" width="200" height="200" />
                                    </a>
                                </Link>
                            </div>
                            <div className="ps-video">

                                <Link href="https://www.youtube.com/watch?v=ilw-qmqZ5zY">
                                    <a
