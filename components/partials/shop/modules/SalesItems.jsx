...
export default function SalesItems({product}) {
    ...
    if (product && product.length > 0) {
        product.map((item, key) => {
            productItemsView =item.productosMasVendidos.map(dato => {
    ...
    return (
        <div className="ps-block--shop-features ps-container">
            <div className="ps-block__header">
                <h3>Clientes que compraron este producto también compraron</h3>
            </div>
