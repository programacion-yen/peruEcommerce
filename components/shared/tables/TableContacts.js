...
const TableContacts = () => {
    ...
    // Array con idMinisitios
    // const [first, setfirst] = useState(second)
    // const [accesoMinisitios, setAccesoMinisitios] = useState([])
    ...
    //     // console.log(form.getFieldValue('minisitios'))
    ...
    return (
        <>
            <div className="row pt-lg-5 mt-lg-4">
                <div className='col-12' style={{ display: 'flex', justifyContent: 'space-between', flex: 1 }}>
                    <h4 className="formDetailsTitleMenu" style={{ flex: 1, marginRight: '25px' }}>Usuarios</h4>
                    <FormChangeContactInformation admin={idcontacto} invoice={direccionFactura} getContact={getContact} />
                </div>
                <div className="col-12">
                    ...
                    <Modal
                        width={1300}
                        style={{ maxWidth: '90%' }}
                        // okText="Modificar contacto"
                        // cancelText="Cerrar"
                        footer={null}
                        open={edit}
                        onCancel={() => {resetEDIT()}}
                        // onOk={(e) => Updateuser(e)}
                        closeIcon={ <i className="icon-cross icon-close-modal" style={{ fontSize: '2.5rem' }}></i> }
                    >
                        <Form
                            form={form}
                            name='crearUsuario'
